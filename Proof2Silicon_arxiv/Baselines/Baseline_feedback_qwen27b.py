...
def RUN_LLM(subfolder, one_line_desc, detailed_desc, temperature, max_iterations=5):
    ...
    for i, prompt in enumerate(prompts, start=1):
        ...
        for attempt in range(max_iterations):
            ...
            promptfile = os.path.join(subfolder, f"Prompt_qwen27b_0.25_{i}_{attempt}.dfy")
            output_dafny_path = os.path.join(subfolder, f"generated_qwen27b_0.25_{i}_{attempt}.dfy")
            Error_path = os.path.join(subfolder, f"error_qwen27b_0.25_{i}_{attempt}.txt")
            ...
            outputs = pipe(messages, max_new_tokens=1024, do_sample=True, temperature=temperature, top_k=50, top_p=0.95)
...
if __name__ == "__main__":
    ...
    process_subfolders("/mnt/shared/gpfs/home/manvij2/UIUC_PROJ_2/dataset/qwen27b", temperature)
