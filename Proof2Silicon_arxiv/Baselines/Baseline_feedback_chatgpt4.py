...
if __name__ == "__main__":
    ...
    parser.add_argument("--workers", type=int, default=4, help="Number of parallel workers (folders/subfolders at once)")
    parser.add_argument(
        "--base_folders",
        nargs="+",
        default=["/mnt/shared/gpfs/home/manvij2/UIUC_PROJ_2/dataset/Dafny_gpt5_2"],
