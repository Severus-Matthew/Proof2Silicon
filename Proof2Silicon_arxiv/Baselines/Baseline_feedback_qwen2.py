...
def RUN_LLM(subfolder, one_line_desc, detailed_desc, temperature, max_iterations=5):
    ...
    for i, prompt in enumerate(prompts, start=1):
        ...
        for attempt in range(max_iterations):
            ...
            promptfile = os.path.join(subfolder, f"Prompt_qwen2_0.25_{i}_{attempt}.dfy")
            output_dafny_path = os.path.join(subfolder, f"generated_qwen2_0.25_{i}_{attempt}.dfy")
            Error_path = os.path.join(subfolder, f"error_qwen2_0.25_{i}_{attempt}.txt")
...
if __name__ == "__main__":
    ...
    process_subfolders("/mnt/shared/gpfs/home/manvij2/UIUC_PROJ_2/dataset/qwen2_", temperature)